...
OUTPUT_DIRECTORY = f"{DIRECTORY}/datasets"
...
def generate_dataset(n, f, c):
    ...
    for _ in range(n):
        ...
        for _ in range(f):
            ...
            instance.append(np.random.randint(2))
            instance.append(np.random.randint(3))
            instance.append(np.random.randint(5))
    ...
    for _ in range(f):
        ...
        allowed_splits.append({*range(2)})
        allowed_splits.append({*range(3)})
        allowed_splits.append({*range(5)})
